...
inline void construct_core_types_paddle(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, PADDLE,              "Paddle 9",               input_seq(JOYCODE_X_INDEXED(8), input_seq::or_code, MOUSECODE_X_INDEXED(8), input_seq::or_code, GUNCODE_X_INDEXED(8)), input_seq(), input_seq() )
	INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, PADDLE,             "Paddle 10",              input_seq(JOYCODE_X_INDEXED(9), input_seq::or_code, MOUSECODE_X_INDEXED(9), input_seq::or_code, GUNCODE_X_INDEXED(9)), input_seq(), input_seq() )
}
...
inline void construct_core_types_paddle_v(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, PADDLE_V,            "Paddle V 9",             input_seq(JOYCODE_Y_INDEXED(8), input_seq::or_code, MOUSECODE_Y_INDEXED(8), input_seq::or_code, GUNCODE_Y_INDEXED(8)), input_seq(), input_seq() )
	INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, PADDLE_V,           "Paddle V 10",            input_seq(JOYCODE_Y_INDEXED(9), input_seq::or_code, MOUSECODE_Y_INDEXED(9), input_seq::or_code, GUNCODE_Y_INDEXED(9)), input_seq(), input_seq() )
}
...
inline void construct_core_types_positional(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, POSITIONAL,          "Positional 9",           input_seq(MOUSECODE_X_INDEXED(8), input_seq::or_code, JOYCODE_X_INDEXED(8), input_seq::or_code, GUNCODE_X_INDEXED(8)), input_seq(), input_seq() )
	INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, POSITIONAL,         "Positional 10",          input_seq(MOUSECODE_X_INDEXED(9), input_seq::or_code, JOYCODE_X_INDEXED(9), input_seq::or_code, GUNCODE_X_INDEXED(9)), input_seq(), input_seq() )
}
...
inline void construct_core_types_positional_v(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, POSITIONAL_V,        "Positional V 9",         input_seq(MOUSECODE_Y_INDEXED(8), input_seq::or_code, JOYCODE_Y_INDEXED(8), input_seq::or_code, GUNCODE_Y_INDEXED(8)), input_seq(), input_seq() )
	INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, POSITIONAL_V,       "Positional V 10",        input_seq(MOUSECODE_Y_INDEXED(9), input_seq::or_code, JOYCODE_Y_INDEXED(9), input_seq::or_code, GUNCODE_Y_INDEXED(9)), input_seq(), input_seq() )
}
...
inline void construct_core_types_dial(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, DIAL,                "Dial 9",                 input_seq(MOUSECODE_X_INDEXED(8), input_seq::or_code, JOYCODE_X_INDEXED(8), input_seq::or_code, GUNCODE_X_INDEXED(8)), input_seq(), input_seq() )
	INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, DIAL,               "Dial 10",                input_seq(MOUSECODE_X_INDEXED(9), input_seq::or_code, JOYCODE_X_INDEXED(9), input_seq::or_code, GUNCODE_X_INDEXED(9)), input_seq(), input_seq() )
}
...
inline void construct_core_types_dial_v(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, DIAL_V,              "Dial V 9",               input_seq(MOUSECODE_Y_INDEXED(8), input_seq::or_code, JOYCODE_Y_INDEXED(8), input_seq::or_code, GUNCODE_Y_INDEXED(8)), input_seq(), input_seq() )
	INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, DIAL_V,             "Dial V 10",              input_seq(MOUSECODE_Y_INDEXED(9), input_seq::or_code, JOYCODE_Y_INDEXED(9), input_seq::or_code, GUNCODE_Y_INDEXED(9)), input_seq(), input_seq() )
}
...
inline void construct_core_types_AD_stick_X(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, AD_STICK_X,          "AD Stick X 9",           input_seq(JOYCODE_X_INDEXED(8), input_seq::or_code, MOUSECODE_X_INDEXED(8), input_seq::or_code, GUNCODE_X_INDEXED(8)), input_seq(), input_seq() )
	INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, AD_STICK_X,         "AD Stick X 10",          input_seq(JOYCODE_X_INDEXED(9), input_seq::or_code, MOUSECODE_X_INDEXED(9), input_seq::or_code, GUNCODE_X_INDEXED(9)), input_seq(), input_seq() )
}
...
inline void construct_core_types_AD_stick_Y(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, AD_STICK_Y,          "AD Stick Y 9",           input_seq(JOYCODE_Y_INDEXED(8), input_seq::or_code, MOUSECODE_Y_INDEXED(8), input_seq::or_code, GUNCODE_Y_INDEXED(8)), input_seq(), input_seq() )
	INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, AD_STICK_Y,         "AD Stick Y 10",          input_seq(JOYCODE_Y_INDEXED(9), input_seq::or_code, MOUSECODE_Y_INDEXED(9), input_seq::or_code, GUNCODE_Y_INDEXED(9)), input_seq(), input_seq() )
}
